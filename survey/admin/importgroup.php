...
* 
* $Id: importgroup.php 5363 2008-07-29 09:16:25Z c_schmitz $
*/
...
if (isset($grouparray) && $grouparray) 
{
	...
	// translate internal links
	$grouprowdata['group_name']=translink('survey_sub', $oldsid, $newsid, $grouprowdata['group_name']);
	$grouprowdata['description']=translink('survey_sub', $oldsid, $newsid, $grouprowdata['description']);
...
//            $oldlid = $questionrowdata['lid'];
		...
		// translate internal links
		$questionrowdata['title']=translink('survey_sub', $oldsid, $newsid, $questionrowdata['title']);
		$questionrowdata['question']=translink('survey_sub', $oldsid, $newsid, $questionrowdata['question']);
		$questionrowdata['help']=translink('survey_sub', $oldsid, $newsid, $questionrowdata['help']);
    ...
    if (isset($answerarray) && $answerarray) 
    {
		...
		// translate internal links
		$answerrowdata['answer']=translink('survey_sub', $oldsid, $newsid, $answerrowdata['answer']);
