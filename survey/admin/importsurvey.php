...
* 
* $Id: importsurvey.php 5422 2008-08-14 20:36:59Z c_schmitz $
*/
...
// find the old language field and replace its contents with the new language shortcuts
    ...
    $surveylsrowdata['surveyls_title']=translink('survey_sub', $surveyid, $newsid, $surveylsrowdata['surveyls_title']);
    $surveylsrowdata['surveyls_description']=translink('survey_sub', $surveyid, $newsid, $surveylsrowdata['surveyls_description']);
    $surveylsrowdata['surveyls_welcometext']=translink('survey_sub', $surveyid, $newsid, $surveylsrowdata['surveyls_welcometext']);
    $surveylsrowdata['surveyls_urldescription']=translink('survey_sub', $surveyid, $newsid, $surveylsrowdata['surveyls_urldescription']);
    $surveylsrowdata['surveyls_email_invite']=translink('survey_sub', $surveyid, $newsid, $surveylsrowdata['surveyls_email_invite']);
    $surveylsrowdata['surveyls_email_remind']=translink('survey_sub', $surveyid, $newsid, $surveylsrowdata['surveyls_email_remind']);
    $surveylsrowdata['surveyls_email_register']=translink('survey_sub', $surveyid, $newsid, $surveylsrowdata['surveyls_email_register']);
    $surveylsrowdata['surveyls_email_confirm']=translink('survey_sub', $surveyid, $newsid, $surveylsrowdata['surveyls_email_confirm']);
...
if (isset($grouparray) && $grouparray) {
	...
	foreach ($grouparray as $ga) {
        ...
        $grouprowdata=array_map('convertCsvreturn2return', $grouprowdata);
    		...
    		// translate internal links
		    $grouprowdata['group_name']=translink('survey_sub', $surveyid, $newsid, $grouprowdata['group_name']);
		    $grouprowdata['description']=translink('survey_sub', $surveyid, $newsid, $grouprowdata['description']);
		...
		if (isset($questionarray) && $questionarray && $newgroup) {
    		...
    		// translate internal links
		    $questionrowdata['title']=translink('survey_sub', $surveyid, $newsid, $questionrowdata['title']);
		    $questionrowdata['question']=translink('survey_sub', $surveyid, $newsid, $questionrowdata['question']);
		    $questionrowdata['help']=translink('survey_sub', $surveyid, $newsid, $questionrowdata['help']);
			...
			// translate internal links
		    		$answerrowdata['answer']=translink('survey_sub', $surveyid, $newsid, $answerrowdata['answer']);
