...
// Module definition
	...
	function displayTrackingHeader($header, $linktxt, $linkurl) {
		...
		<p><a href="<?php echo $linkurl?>" title="" class="helplink"><font face="Arial" size="2"><?php echo $linktxt?></font></a><br />
		</p></td></tr></tbody></table>
		<?php
	}
...
?>		
			...
			<p><img style="margin-bottom: 0pt; margin-right: 15px" alt="" title="" src="images/stories/behavior_icons/<?php echo $behaviorSpecs[$behaviorID]['image'] ;?>" align="left" height="40" width="40" /></p></td>
			<td>
<?php		
			...
			if ($behaviorID == 1) {
				...
				?>
				<div class="indent2"><h3>OR</h3></div>
				<div align="right">

				<label for="myform">How many <?php echo _HCC_MINUTES?> of moderate activity?</label><input name="response1A" value="<?php echo _HCC_MINUTES?>"  onblur="if(this.value=='') this.value='<?php echo _HCC_MINUTES?>';" 
			onfocus="if(this.value=='<?php echo _HCC_MINUTES?>') this.value='';" size="10" maxlength="<?php echo strlen( _HCC_MINUTES) ?>" type="text">    
			</div>
				<div align="right">
				<label for="myform">How many <?php echo _HCC_MINUTES?> of vigorous activity?</label><input name="response1B" value="<?php echo _HCC_MINUTES?>"  onblur="if(this.value=='') this.value='<?php echo _HCC_MINUTES?>';" 
			onfocus="if(this.value=='<?php echo _HCC_MINUTES?>') this.value='';" size="10" maxlength="<?php echo strlen( _HCC_MINUTES) ?>" type="text">    
			</div>
...
?>
		...
		<tr>
		<td>
				<div class="important-grey"><span class="important-title"><?php echo 'My Score' ;?></span>
				<table style="width: 100%; border-collapse: collapse" border="0" cellpadding="3" cellspacing="0">
				<tbody>
				<tr valign="top">
				<td valign="top" width="110">
				<p><img style="margin-bottom: 0pt; margin-right: 15px" alt="" title="" src="images/stories/behavior_icons/<?php echo $behaviorSpecs[6]['image'] ;?>" align="left" height="40" width="40" /></p></td>
				<td>
		<?php 
...
function displaySummary( $MRFscore,  $remindTitle, $remindBody) {
global $option, $view, $itemid, $id;
global $my;
global $userDB, $user, $rightNow, $behaviorSpecs;
...
/*		*/
	...
	?>
			...
			<tr valign="top">
			<td valign="top" width="110">
			<p><img style="margin-bottom: 15px; margin-right: 15px;" alt="" title="" src="images/stories/behavior_icons/<?php echo $behaviorSpecs[$behaviorID]['image'] ;?>" align="left" height="100" width="100"></p></td>
			<td>
