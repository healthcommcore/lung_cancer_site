...
<title>Follow Up Surveys TFR #2</title>
...
<body>
  <!-- Begin Wrapper -->
   <div id="wrapper">
         ...
         <div id="header">
		 	<br><br>
		<h2 align = "center">Generate participants for follow up survey</h2>  
		<br><p align = "right">
	    ...
	    <input type = "submit" value = "log out" size = 100></form></p>  
		 ...
		 <div id="faux">
		       ...
		       <div id="rightcolumn">
	<br><br>		   
    <p>To generate a list of participants for the follow-up survey, select a date range below and click on "Generate List."</p>
	<br>
...
<form method="POST" id="myform" action="download_fu_report.php" onSubmit="return checkForm(this);">
...
<tr><td colspan="2"><input type = "submit" value = "Generate participant list" size="100" onclick="return javascript:checkdates();"></td></tr>
</table>
