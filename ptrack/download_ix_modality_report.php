...
$sql2 = $sql1." AND j.ixModality='1'"; // web only 
$sql3 = $sql1." AND j.ixModality='2'"; // print only 
...
// SQL statements 
$sql = "SELECT count(*) AS total FROM part_info p, enrollment j, appt a, provider pr WHERE p.partID = j.partID 
        AND p.MRN = a.MRN AND a.provdID = pr.provID AND p.ptStatus = 'A' ";//AND j.heID IS NULL"; // no coaching calls 
$sql1 = $sql." AND pr.randArm = 'mats'"; // both types of enrollment
$sql2 = $sql." AND pr.randArm = 'mats' AND j.ixModality='1'"; // web only 
$sql3 = $sql." AND pr.randArm = 'mats' AND j.ixModality='2'"; // print only 
$sql4 = $sql1." AND j.remindRand='1' AND j.dateRemOpt IS NULL"; // reminder opt in 
$sql5 = $sql1." AND (j.remindRand='2' OR j.dateRemOpt IS NOT NULL)"; // reminder no
$sql6 = $sql3." AND dateIXChange != '0000-00-00'"; // web to print 
$sql7 = $sql6." AND ixID = 1"; // web inactivity 
...
// SQL statements 
$sql = "SELECT count(*) AS total FROM part_info p, enrollment j, appt a, provider pr WHERE p.partID = j.partID 
        AND p.MRN = a.MRN AND a.provdID = pr.provID AND p.ptStatus = 'A'";
$sql1 = $sql." AND pr.randArm = 'mats+cc'"; // both types of enrollment
$sql2 = $sql." AND pr.randArm = 'mats+cc' AND j.ixModality='1'"; // web only 
$sql3 = $sql." AND pr.randArm = 'mats+cc' AND j.ixModality='2'"; // print only 
$sql4 = $sql1." AND j.remindRand='1' AND j.dateRemOpt IS NULL"; // reminder opt in 
$sql5 = $sql1." AND (j.remindRand='2' OR j.dateRemOpt IS NOT NULL)"; // reminder no
$sql6 = $sql3." AND dateIXChange != '0000-00-00'"; // web to print 
$sql7 = $sql6." AND ixID = 1"; // web inactivity 
