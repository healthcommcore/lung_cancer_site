...
$today = date('Y-m-d');
//--> Connection Info 
$checkfile = '/var/www/new/html/hvma/CadenceAppt.txt'; // data import file gets placed in folder via FTP
//$checkfile = '/var/www/new/html/hvma/test1.txt'; test for bug fixing
...
$ignorefile = '/var/www/new/html/lung_cancer_site/ptrack/cron/ignore-names.txt';
...
// Logs 
$importLogPath = '/var/www/new/html/hvma/import_complete/'; // live path 
//$importLogPath = $_SERVER["DOCUMENT_ROOT"].'/hvma/import_complete/'; // test path 
$resultLogsPath = '/var/www/new/html/logs/hd2/'; // LIVE 
