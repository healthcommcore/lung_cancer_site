...
$jaxFuncNames[]	= 'jcxEmailForm';			# Backend show email form
$jaxFuncNames[] = 'jcxSendMail';			# Backend send email
$jaxFuncNames[]	= 'jcxPreviewComment';		# Preview comments in front end.
$jaxFuncNames[] = 'jcxMoveComment';			# Move comments from back end.
$jaxFuncNames[] = 'jcxMoveCommentForm';		# Show move comment form from back end.